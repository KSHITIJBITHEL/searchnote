var inputTitle = document.querySelector('.new-note input');//where Title is entered
var inputBody = document.querySelector('.new-note textarea');//where body is entered

var noteContainer = document.querySelector('.note-container');//place where the notes are placed once they are made
...
function displayNote(title, body) {
  ...
  note.appendChild(noteEdit);// we deleted the division where the note was stored and now add the division wher it can be edited 
